...
export default function RegistryPage() {
  return (
    <section className="max-w-2xl mx-auto px-4 flex flex-col items-center justify-around text-center font-lucy text-foreground">
      ...
      <div className="space-y-6 text-lg">
        ...
        <div className="mt-10 space-y-4 text-base text-foreground">
          ...
          <p>
            <strong>Zelle:</strong> <span className="text-secondary">571-451-7083</span>
          </p>
          <p>
